...
if(!require("neotoma2")) install.packages("neotoma2")
...
::::{.r-fit-text}
* [💽go to R/Exercises/Functional project/Picea_CZ_TroughTime.R](https://github.com/SSoQE/SSoQE-Functional_Programming_with_fossil_pollen_data/blob/main/R/Exercises/Functional workflow/Picea_CZ_TroughTime.R)
